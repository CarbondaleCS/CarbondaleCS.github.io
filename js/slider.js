...
(function() {
  ...
  var slides = [
    {
      ...
      content:
        '<p>A talk on web application security. Learn the basics on how to prevent common attacks on your web applications, such as XSS.</p>',
      watch: '#',
      git: '#'
    },
    {
      ...
      content:
        '<p>Learn about GitHub, and gain familiarity with Git. Start contributing to the open-source community!</p>',
      watch: '#',
      git: '#'
    },
    {
      ...
      content:
        '<p>Learn how to navigate your computer and more with the command-line.</p>',
      watch: '#',
      git: '#'
    }
  ];
  ...
  function slider() {
    ...
    slideNumber > 0
      ...
      : sliderDots.children[sliderDots.children.length - 1].classList.remove(
          'active'
        );
    slideNumber++;
  }
